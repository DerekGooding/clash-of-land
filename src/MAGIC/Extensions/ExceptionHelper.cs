...
namespace ClashLand.Extensions
{
    ...
    {
        internal static Exception CreateFromEntityValidation(DbEntityValidationException ex)
        {
            return new Exception(GetDbEntityValidationMessage(ex), ex);
        }

        internal static string GetDbEntityValidationMessage(DbEntityValidationException ex)
        {
        ...
        internal static IEnumerable<Exception> GetInners(Exception ex)
        {
            for (Exception e = ex; e != null; e = e.InnerException)
                yield return e;
        }

        internal static Exception CreateFromDbUpdateException(DbUpdateException dbUpdateException)
        {
