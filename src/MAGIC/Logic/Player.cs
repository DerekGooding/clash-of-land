...
using Npcs = ClashLand.Logic.Structure.Slots.Npcs;
...
namespace ClashLand.Logic
{
    internal class Player : ICloneable
    {
        ...
        [JsonProperty("donations")] internal int Donations; //= Core.Resources.Random.Next(0, 100);
        [JsonProperty("received")] internal int Received;// = Core.Resources.Random.Next(0, 100);

        [JsonProperty("shield")] internal int Shield;
        [JsonProperty("guard")] internal int Guard;
        [JsonProperty("score")] internal int Trophies = Core.Resources.Random.Next(1500, 3000);
        [JsonProperty("duel_score")] internal int Builder_Trophies = Core.Resources.Random.Next(200, 500);
        ...
        internal byte[] ToBytes
        {
            get
            {
                ...
                {
                    _Packet.AddInt(Achivement.Id);
                    _Packet.AddInt(Achivement.Data);
                }
    ...
    {
        public object DiamondReward { get; internal set; }
        public int ExpReward { get; internal set; }
    }
}