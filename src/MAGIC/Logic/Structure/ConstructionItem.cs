...
internal class ConstructionItem(Data data, Level level) : GameObject(data, level)
{
    internal Timer BoostTimer;
    internal Timer Timer;

    internal bool Locked;
    internal bool IsBoosted = false;
    internal bool IsBoostPause = false;
    internal int UpgradeLevel = -1;
    internal bool IsConstructing = false;
    internal bool IsGearing = false;
